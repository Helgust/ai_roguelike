...
public:
  ...
  void enter(flecs::world& ecs, flecs::entity entity) const override 
  {
    entity.set([&](Color& cur_color, OriginalColor& orig_color)
    {
  ...
  void exit(flecs::world& ecs, flecs::entity entity) const override 
  {
    entity.set([&](Color& cur_color, OriginalColor& orig_color, Action& a)
    {
  ...
  void act(float/* dt*/, flecs::world& ecs, flecs::entity entity) const override
  {
    entity.set([&](Hitpoints& hp, Action& a)
      {
          a.action = EA_HEAL;
      });
  }
...
public:
  ...
  bool isAvailable(flecs::world& ecs, flecs::entity entity) const override
  {
    bool cooldownIsFinished = false;
    entity.get([&](const HealingCooldown& healing_cooldown)
      {
        if (healing_cooldown.cooldown == 0)
          cooldownIsFinished = true;
      });
    return cooldownIsFinished;
  }
};
